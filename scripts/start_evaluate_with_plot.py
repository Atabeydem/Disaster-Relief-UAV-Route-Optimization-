...
def main():
    ...
    eval_path = r'2024_05_07_04_22_Multirotor_No_CNN_SAC'
    ...
    evaluate_thread.env.rgb_signal.connect(gui.rgb_cb)
    evaluate_thread.env.depth_signal.connect(gui.depth_cb)
