...
def main():
    ...
    config_file = 'configs/config_Maze_SimpleMultirotor_3D.ini'
    ...
    training_thread.env.rgb_signal.connect(gui.rgb_cb)
    training_thread.env.depth_signal.connect(gui.depth_cb)
